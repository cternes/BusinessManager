 ...
 ******************************************************************************/
package org.businessmanager.web.jsf.listener;
...
public class LoginListener implements PhaseListener {
	...
	public void beforePhase(PhaseEvent event) {
        ...
        if (e instanceof BadCredentialsException) {
            ...
            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, ResourceBundleAccessor.getString("login_failed"), ResourceBundleAccessor.getString("login_failed")));
        }
	}
